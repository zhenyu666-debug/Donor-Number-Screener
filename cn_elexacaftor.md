...
第一步：TLC监测反应（薄层色谱）
  ...
  设备：TLC硅胶板 + UV灯
  淘宝搜：TLC硅胶板 60F254 20片 ¥15
  UV灯：紫外灯 254nm ¥25

  怎么做：
    1. 反应过程中，用毛细管（玻璃毛细管 ¥5）蘸一点反应液
    2. 在TLC板上点一个小点
  ...
  怎么看结果？
    原料点：底部的深色点（消失 = 反应进行中）
    产品点：往上爬的新点（出现 = 产物生成）
    杂质点：如果出现很多新的点，可能有副反应

  没有UV灯怎么办？
    用碘熏：把TLC板放进装了碘晶体的密闭容器
    有机物会变棕色
...
第一步残留 — 硼氢化钠（NaBH4）
  ...
  危害：
    氢气：腹胀，极端情况可能损伤消化道
    硼：硼中毒，症状包括恶心、呕吐、头痛
    致死量：硼酸钠约10-20克（你残留的那点远低于此）
  处理：萃取时充分洗涤，NaBH4会被水洗掉
...
第一步残留 — 甲醇（CH3OH）
  ...
  如果混进药品：
    代谢产物：甲醛、甲酸
    危害：损伤视神经，可能致盲（10ml以上有危险）
    积累性：每次吃药都摄入一点，慢性中毒
  处理：旋转蒸发仪蒸干，甲醇沸点64.7°C，很容易除去
  关键：确保旋蒸温度达到50-60°C，保持10分钟以上

第二步副产物 — 未反应的原料A/B

  原料A（Boc-吡唑醇）：不明毒性，建议控制在1%以下
  原料B（酮的还原不完全）：可能仍有部分醛/酮结构
    危害：轻度刺激性，长期服用安全性未知
  处理：过柱子可以有效分离

第二步副产物 — DIAD残留

  DIAD（二偶氮异丁腈）：用于Mitsunobu反应
  外观：油状液体
  危害：
    可能含有叠氮基团，有一定毒性
    没有充分数据表明长期服用的安全性
...
安全建议
  ...
  4. 纯度越低，风险越高
  5. 最保险的做法：找有设备的人帮你做HPLC检测
     （高校化学系一般都有，样品寄过去检测约¥200）
```
